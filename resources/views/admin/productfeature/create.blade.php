                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(array('route' => 'admin.productfeature.store','method'=>'POST','class'=>'form form-horizontal')) !!}
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::textarea('description', null, array('placeholder' => 'Description','class' => 'form-control','rows'=>4)) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::select('product_type', $arrOfProductType,'', array('class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::text('version', null, array('placeholder' => 'Version','class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <label>{{ Form::checkbox('is_active', 'Yes', true, array('class' => '')) }}</label>
                                                    </div>
                                                </div>
