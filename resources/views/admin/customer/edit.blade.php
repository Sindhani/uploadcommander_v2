                    ...
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/role') }}">{{ __('Customer') }}</a></li>
                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::model($customer, ['method' => 'PATCH','route' => ['admin.customer.update', $customer->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control">Packages</label>
                                                    <div class="col-md-9">
                                                        {!! Form::select('package_id', $packages,$customer->package_id, array('class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control">Customer Number</label>
                                                    <div class="col-md-9">
                                                        {!! Form::text('customer_number', $customer->customer_number, array('placeholder' => 'Customer Number','class' => 'form-control','readonly')) !!}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-actions right">
                                                <button type="button" class="btn btn-danger mr-1" onclick="location.href='{{ url('admin/customer') }}'">
