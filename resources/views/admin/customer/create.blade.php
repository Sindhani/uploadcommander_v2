                    ...
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/customer') }}">{{ __('Customer') }}</a></li>
                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(array('route' => 'admin.customer.store','method'=>'POST','class'=>'form form-horizontal')) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control">Packages</label>
                                                    <div class="col-md-9">
                                                        {!! Form::select('package_id', $packages,'', array('class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::text('customer_number', $customerNumber, array('placeholder' => 'Customer Number','class' => 'form-control','readonly')) !!}
                                                    </div>
                                                </div>
