        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Add Document Template</h3>
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/home') }}">{{ __('Home') }}</a></li>
                                <li class="breadcrumb-item"><a href="{{ url('/admin/document_template') }}">{{ __('Caption') }}</a></li>
                                <li class="breadcrumb-item active">Add Document Template</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(array('route' => 'admin.document_template.store','method'=>'POST','class'=>'form form-horizontal')) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput5">Template Name</label>
                                                    <div class="col-md-9">
                                                        {!! Form::text('template_name', null, array('placeholder' => 'Caption','class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::textarea('email_body', '', array('placeholder' => 'Description','class' => 'form-control tinymce','rows'=>4)) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row skin skin-square ml-1">
                                                            <input type="checkbox" name="is_active" id="is_active" class="switchery" value="Yes">
