        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Document Template</h3>
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/home') }}">{{ __('Home') }}</a></li>
                                <li class="breadcrumb-item"><a href="{{ url('/admin/document_template') }}">{{ __('Caption') }}</a></li>
                                <li class="breadcrumb-item active">Edit Document Template</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                            ...
                                            {!! Form::model($emailTemplate, ['method' => 'PATCH','route' => ['admin.document_template.update', $emailTemplate->id]]) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput5">Template Name</label>
                                                    <div class="col-md-9">
                                                        {!! Form::text('template_name', $emailTemplate->template_name, array('placeholder' => 'Template Name','class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
