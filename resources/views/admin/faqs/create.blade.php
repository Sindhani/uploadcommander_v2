        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Add FAQ Entry</h3>
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">{{ __('Support') }}</a></li>
                                <li class="breadcrumb-item active">FAQ - Add Entry</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <div class="archived mt-3">
                                            ...
                                            <form class="form-horizontal" id="faq_form" action="#" method="post" accept-charset="utf-8">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="checkbox" name="support_bot_use" class="is_menu" id="support_bot_use">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <select name="assignment" class="form-control assignment" id="assignment">
                                                            ...
                                                            @foreach($faqs as $faq)
                                                            <option value="{{$faq->description}}">{{$faq->description}}</option>}
                                                            option
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row" style="justify-content: flex-end;margin-right: 0%;">
                                                    <a href="{{route('admin.faq.index')}}" class="btn btn-danger mr-1"><i class="fa fa-times mr-1"></i>Cancel</a>
