                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="archived mt-3">
                                        	<div class="row" style="justify-content: flex-end;">
                                            	<a href="{{route('admin.faq.create')}}" type="button" class="btn btn-primary mr-1" ><i class="ft-plus"></i>Add Entry</a>
                                        	</div>
                                            <table id="myTable">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="background-color: #f4f5fa;">
                                                        ...
                                                        <td>@if($faq->is_active == '1') Active @else InActive @endif</td>
                                                        <td>
                                                            <div class="row">
                                                                <button class="menu_active" type="button" data-status="menu" data-id="{{$faq->id}}" style="@if($faq->is_active == '1') display: none; @else display: block; @endif"><i class="ft-check mr-1"></i></button>
                                                                <button class="menu_inactive" type="button" data-status="menu" data-id="{{$faq->id}}" style="@if($faq->is_active == '1') display: block; @else display: none; @endif"><i class="fa fa-times mr-1"></i></button>
                                                                <a href="{{route('admin.faq.edit', $faq->id)}}?edit={{$faq->is_menu}}"><i class="ft-edit mr-1"></i></a>
                                                                <button class="delete" type="button" data-delete="menu" data-id="{{$faq->id}}"><i class="ft-trash"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    @foreach($question as $child)
                                                    @if($faq->description == $child->assignment)
                                                    <tr>
                                                        <td>{{$count++}}</td>
                                                        <td></td>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <a href="{{route('admin.faq.edit', $child->id)}}?edit={{$child->is_menu}}"><i class="ft-edit mr-1"></i></a>
...
<script>
    $('.delete').on('click', function(event){
      ...
      // alert(delete_data);
      // alert(data_id);
      var route = "{{route('admin.faq.destroy',"+data_id+")}}";
      // alert(route);
      if(delete_data == 'menu'){
          $.confirm({
            title: 'Confirm!',
