                    ...
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('messages.roles') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="heading-elements">
                                        <button type="button" class="btn btn-primary btn-min-width mr-1 mb-1 text-right" onclick="location.href='{{ url('admin/role/create') }}'"> <i class="la la-plus"></i> Add Roles</button>
                                    </div>
                                </div>
