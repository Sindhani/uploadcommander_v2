        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Language</h3>
                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::model($language, ['method' => 'PATCH','route' => ['admin.language.update', $language->id],'class'=>'form form-horizontal']) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control">Name</label>
                                                    <div class="col-md-9">
                                                        {!! Form::text('language_name', $language->language_name, array('placeholder' => 'Name','class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::select('country_code', $arrOfCountryCode, $language->country_code, array('class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row pb-1">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row skin skin-square ml-1">
                                                            <input type="checkbox" name="status" id="status" class="switchery" {{ ($language->status=='active')?"checked":"" }} value="active">
