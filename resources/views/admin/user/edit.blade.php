                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        {!! Form::model($user, ['method' => 'PATCH','route' => ['admin.user.update', $user->id],'class'=>'form form-horizontal', 'enctype'=>'multipart/form-data']) !!}
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-3 text-center">
                                                    @if ($user->photo)
                                                        <div class="circle">
                                                            <img class="profile-pic" src="{{ asset('user_photo/'.$user->photo) }}">
                                                        </div>
                                                    @else
                                                ...
                                                <div class="col-md-9">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {!! Form::text('first_name', $user->first_name, array('placeholder' => 'First Name','class' => 'form-control','required')) !!}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {!! Form::text('surname', $user->surname, array('placeholder' => 'Surname','class' => 'form-control','required')) !!}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                {!! Form::select('timezone', $timezones,$user->timezone, array('class' => 'form-control','required')) !!}
                                                            </div>
                                                        </div>
