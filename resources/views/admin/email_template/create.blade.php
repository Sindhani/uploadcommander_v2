                            ...
                            <div class="card">
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(array('route' => 'admin.email_template.store','method'=>'POST','class'=>'form form-horizontal')) !!}
                                            <div class="form-body">

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput5">Template Name</label>
                                                    <div class="col-md-9">
                                                        {!! Form::text('template_name', null, array('placeholder' => 'Template Name','class' => 'form-control','required')) !!}
                                                    </div>
                                                </div>
