        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Update HelpDesk Entry</h3>
                    <div class="breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">{{ __('Support') }}</a></li>
                                <li class="breadcrumb-item active">HelpDesk-Update Entry</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="archived mt-3">
                                            ...
                                            <form class="form-horizontal mt-2" id="helpdesk_form" action="#" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="form-group row" @if(isset($menu_edit)) style="display: none" @elseif(isset($child_edit)) @endif>
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="linked_page" type="text" name="linked_page" value="{{$menu->linked_page}}" class=" form-control linked_page"  placeholder="Add default Site" >
                                                ...
                                                <div class="form-group row" @if(isset($menu_edit)) style="display: none;" @elseif(isset($child_edit)) @endif>
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <select name="assignment" class="form-control assignment" id="assignment">
                                                            ...
                                                            <option value="{{$help->description}}" @if($menu->assignment == $help->description) Selected @endif>{{$help->description}}</option>}
                                                            option
                                                            @endforeach
                                                        </select>
                                                    </div>
...
<script>
   ...
   $('#helpdesk_form').on('submit', function(event){
      ...
      $.ajax({
         url:"{{route('admin.helpdesk.update', "+id+")}}",
         method:"POST",
